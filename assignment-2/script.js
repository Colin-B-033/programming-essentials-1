...
function calculate() {
    ...
    const value1 = parseInt (number1.value); // Add logic to retrieve the value from number1
    const value2 = parseInt (number2.value); // Add logic to retrieve the value from number2
